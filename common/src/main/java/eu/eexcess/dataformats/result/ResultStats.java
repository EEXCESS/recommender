...
public class ResultStats implements Serializable {
    ...
    public ResultStats(String partnerQuery, long partnerCallTime, long firstTransformationTime, long secondTransformationTime, long enrichmentTime, int resultCount) {
    ...
    public String toString() {
        return "ResultStats [partnerQuery=" + partnerQuery + ", partnerCallTime=" + partnerCallTime + ", firstTransformationTime=" + firstTransformationTime
                + ", secondTransformationTime=" + secondTransformationTime + ", enrichmentTime=" + enrichmentTime + "]";
    }
