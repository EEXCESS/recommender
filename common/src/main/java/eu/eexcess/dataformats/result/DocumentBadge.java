...
/**
 * Document identifier for each document. Can be returned as list to get the
 * details of the documents back from the server.
 * 
 * @author hziak
 */
public class DocumentBadge implements Serializable {
    ...
    public String toString() {
        return "DocumentBadge [id=" + id + ", uri=" + uri + ", provider=" + provider + "]";
    }
