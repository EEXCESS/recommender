...
public class Interest implements Serializable {
    ...
    public String toString() {
        return "Interest [text=" + text + ", weight=" + weight + ", confidence=" + confidence + ", competenceLevel=" + competenceLevel + ", source=" + source + ", uri=" + uri
                + "]";
    }
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((competenceLevel == null) ? 0 : competenceLevel.hashCode());
