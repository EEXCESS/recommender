...
public class ContextNamedEntitiesElement implements Serializable {
    ...
    public ContextNamedEntitiesElement(String text, Double weight, Double confidence, String uri) {
        super();
        this.text = text;
        this.weight = weight;
    ...
    public String toString() {
        return "ContextNamedEntitiesElement [text=" + text + ", weight=" + weight + ", confidence=" + confidence + ", uri=" + uri + "]";
    }
