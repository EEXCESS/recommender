...
public class GrphTupleCollector implements CategoryTupleCollector {
    ...
    public static class Statistics {
        ...
        public String toString() {
            return "edges inflated to graph: nodes [" + numTotalTaken + "] edge duplicates [" + numDuplicates + "] self linked [" + numSelfLinked
                    + "] total collecting calls [" + numTotalTaken + "]";
        }
    }
    ...
    public void storeToFile(File graphFile, AbstractGraphWriter writer) throws /*
    ...
    public static Grph readFromFile(File graphFile, AbstractGraphReader reader) throws /*
                                                                                        * FileNotFoundException
                                                                                        * ,
