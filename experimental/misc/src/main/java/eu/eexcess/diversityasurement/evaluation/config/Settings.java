...
public class Settings {
    ...
    public static class RelevanceEvaluation {
        ...
        public static class IOFiles {
            ...
            public static final File outLuceneIndexDirectory = new File("/opt/iaselect/results/category-relevance-index-big/");
            ...
            public static final File outCategoryIdToName = new File("/opt/iaselect/results/cache/category-id-to-name.bin");
            public static final File outCategoryNameToId = new File("/opt/iaselect/results/cache/category-name-to-id.bin");
        ...
        public static class EstimationArguments {
            public static final int numTopDocumentsToConsider = 60;
            public static final int numKClosestCategoryNeighborsToConsider = 1000;
