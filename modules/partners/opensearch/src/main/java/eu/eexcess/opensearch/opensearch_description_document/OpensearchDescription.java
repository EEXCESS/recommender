	...
	public String toString() {
		return new StringBuilder().append(
				"shortname[" + shortName + "] description[" + description
						+ "] longName[" + longName + "] tags[" + tags
						+ "] searchLinks[" + searchLinks + "] queries ["
						+ queries + "] contact[" + contact + "] syndication ["
						+ syndicationRight + "] attribution [" + attribution
						+ "] adultContent[" + adultContent + "] languages["
						+ languages + "] outputEncodings[" + outputEncodings
						+ "] inputEndocings [" + inputEncodings + "] images["
						+ images + "] developer[" + developer + "] xmlns["
						+ xmlns + "]").toString();
	}
}
