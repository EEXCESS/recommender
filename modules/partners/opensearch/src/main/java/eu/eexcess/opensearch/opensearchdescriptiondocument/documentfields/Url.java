...
public class Url {
    ...
    public Url(String type, String template, UrlRel rel, int indexOffset, int pageOffset) {
        this.type = type;
    ...
    public String toString() {
        return new StringBuilder().append(
                "type[" + type + "] template[" + template + "] rel[" + rel + "] indexOffset[" + indexOffset + "] pageOffset[" + pageOffset + "]").toString();
    }
