...
import ${groupId}.dataformats.result.Result;
import ${groupId}.dataformats.result.ResultList;
import ${groupId}.partnerdata.api.EEXCESSDataTransformationException;
import ${groupId}.partnerdata.reference.PartnerdataLogger;
import ${groupId}.partnerdata.reference.PartnerdataTracer;
import ${groupId}.partnerdata.reference.Transformer;
