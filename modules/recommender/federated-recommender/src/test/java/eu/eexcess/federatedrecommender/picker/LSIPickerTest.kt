...
//        }
    ...
    private fun getResultList(partner1: PartnerBadge, partner2: PartnerBadge): PartnersFederatedRecommendations? {
        ...
        resList1Element1.title="[picture]Critique of Lovelace Meta-Analysis"
        resList1Element1.mediaType="picture"
        ...
        resList1Element2.title="[Text]Fotografie, Zeichnung von Georg Herwegh (Foto)"
        ...
        resList1Element3.title="[Text]Notizbuch"
        resList1Element3.mediaType="text"
        var resList1Element4 = Result()
        resList1Element4.description=""
        resList1Element4.title="[picture] Bild eines jungen Mannes mit rotem Hut (mit Feder) blauer Weste und Stock in der Hand. 3/4 Figur. "
        resList1Element4.mediaType="picture"
        ...
        resList2Element1.title="[Text]Ada Lovelace - 4b57r4c7"
        resList2Element1.mediaType="text"
        var resList2Element2 = Result()
        resList2Element2.description=""
        resList2Element2.title="[picture Date Licence] LEP - The Lord of the Collider Rings at CERN 1980-2000"
        resList2Element2.mediaType="picture"
        ...
        resList2Element3.title="[Text]Manuskript"
        ...
        resList2Element4.title="[Text]englische Literatur"
    ...
    private fun getResultListNeutral(partner1: PartnerBadge, partner2: PartnerBadge): PartnersFederatedRecommendations? {
        ...
        var resList1Element1 = Result()
        resList1Element1.description=""
        resList1Element1.title="[picture] Fotografie, Zeichnung von Georg Herwegh (Foto)"
        resList1Element1.mediaType="picture"
        var resList1Element2 = Result()
        ...
        resList1Element3.title="[Text] Fotografie, Zeichnung von Georg Herwegh (Foto)"
        resList1Element3.mediaType="text"
        var resList1Element4 = Result()
        resList1Element4.description=""
        resList1Element4.title="[picture] Fotografie, Zeichnung von Georg Herwegh (Foto)"
        resList1Element4.mediaType="picture"
        resList1.results.add(resList1Element1);
        resList1.results.add(resList1Element2);
        resList1.results.add(resList1Element3);
        ...
        resList2Element1.title="[Text] Fotografie, Zeichnung von Georg Herwegh (Foto)"
        resList2Element1.mediaType="text"
        var resList2Element2 = Result()
        resList2Element2.description=""
        resList2Element2.title="[picture Date Licence] Fotografie, Zeichnung von Georg Herwegh (Foto)"
        resList2Element2.mediaType="picture"
        resList2Element2.date="1980"
        resList2Element2.licence="Apache 2.0"
        var resList2Element3 = Result()
        resList2Element3.description=""
        resList2Element3.title="[Text] Fotografie, Zeichnung von Georg Herwegh (Foto)"
        resList2Element3.mediaType="text"
        var resList2Element4 = Result()
        resList2Element4.description=""
        resList2Element4.title="[Text] Fotografie, Zeichnung von Georg Herwegh (Foto)"
        resList2Element4.mediaType="text"
        resList2.results.add(resList2Element1);
        resList2.results.add(resList2Element2);
        resList2.results.add(resList2Element3);
