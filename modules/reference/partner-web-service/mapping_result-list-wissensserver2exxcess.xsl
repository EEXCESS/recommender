			      ...
			      <xsl:for-each select="/results/result|/objects/object">
				        ...
				        <xsl:element name="ore:Aggregation">
					          ...
					          <xsl:element name="edm:aggregatedCHO">
						            ...
						            <xsl:element name="eexcess:PublicationObject">
							              <xsl:attribute name="rdf:about">
...
-->
				        ...
				        <xsl:element name="eexcess:PublicationProxy">
					          <xsl:attribute name="rdf:about">
      ...
      <apply-templates xmlns="http://www.w3.org/1999/XSL/Transform" mode="m2" select="intro"/>
   </xsl:template>
	  <xsl:template name="Main.Date"/>
	  <xsl:template name="Main.Identifier">
      <apply-templates xmlns="http://www.w3.org/1999/XSL/Transform" mode="m0" select="article"/>
   </xsl:template>

   <template xmlns="http://www.w3.org/1999/XSL/Transform" match="article" mode="m0">
   ...
   <template xmlns="http://www.w3.org/1999/XSL/Transform" match="intro" mode="m2">
