...
public class PartnerRecommenderTestHelper {
	...
	{
		/*
		 <eexcess-document-badges-list>
        <documentBadge>
            <id>E1.6882</id>
            <uri>http://www.kim.bl.openinteractive.ch/sammlungen#f19e71ca-4dc6-48b8-858c-60a1710066f0</uri>
            <provider>KIM.Portal</provider>
        </documentBadge>
        <documentBadge>
            <id>E1.6880</id>
            <uri>http://www.kim.bl.openinteractive.ch/sammlungen#f04ae6c5-45fd-ff40-333c-f3b50dffbe3d</uri>
            <provider>KIM.Portal</provider>
        </documentBadge>
</eexcess-document-badges-list>
